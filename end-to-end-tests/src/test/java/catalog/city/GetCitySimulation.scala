...
class GetCitySimulation extends Simulation {
  ...
  val get = scenario("Get all the information about one city").exec(karateFeature("classpath:catalog/city/get_city_ok.feature"))
